...
@section('title', 'Tums | Chi tiết đơn nhập')
                    ...
                    <div class="col-lg-8">
                        <div class="ss1">
                            <header class="ss1-heard row border-bottom">
                                <div class="col-md-6">
                                    <h5 style="font-weight: 600">Chi tiết đơn nhập </h5>
                                </div>
                            ...
                            <div class="ss1-payment row">
                                @if($status == 4)
                                    <div class="mr-auto col-sm-8">
                                        ...
                                        <span style="font-size: 15px">ĐÃ XÁC NHẬN THANH TOÁN {{ number_format($total, 0, ',', '.') }}đ</span>
                                    </div>
                                @endif
                            </div>
<hr>
                    ...
                    <div class="col-lg-4">
                        <div class="">
                            ...
                            <div class="ss2 ss2-cus row">
                                <div class="mr-auto col-sm-10">
                                    <h5 style="font-weight: 600">Nhà cung cấp</h5>
                                    <a href="#">
                                        {{ $users->full_name }}
                                    </a>
                                    <br>
    ...
    <div class="example-print">
        <div class=" row">
            ...
            <div class="col-6 text-left">
                <b>Nhà cung cấp: </b> {{ $users->full_name }}<br>
